      ...
      >
        ...
        <div className="flex justify-center mb-2">
          <div className="flex items-center gap-3">
            <div className="h-11 w-11 rounded-xl bg-primary/20 flex items-center justify-center border border-primary/30">
        ...
        <div className="space-y-3 mt-4">
          ...
          <form action={signInWithGoogle}>
            <Button
              ...
              variant="outline"
              size="lg"
              className="w-full h-12 text-base border-border/60 hover:bg-accent hover:border-border"
            >
              <GoogleIcon />
          ...
          {/* LinkedIn - Placeholder for future */}
          {/* 
...
// Placeholder for future LinkedIn icon
