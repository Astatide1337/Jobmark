...
export function EditorialHero() {
  ...
  return (
    <section ref={containerRef} className="relative flex min-h-screen items-center overflow-hidden py-24 lg:py-20">
      ...
      <motion.div
        ...
        animate={prefersReducedMotion ? undefined : { x: [0, -35, 25, 0], y: [0, 24, -18, 0], scale: [1, 1.08, 0.96, 1] }}
        ...
        <div className="flex flex-col gap-16 xl:flex-row xl:items-center xl:justify-between xl:gap-24 2xl:gap-32">
          <motion.div style={{ y: textY }} className="relative z-10 w-full space-y-8 xl:max-w-xl">
            ...
            >
              ...
              <span className="text-primary font-mono text-sm tracking-wide uppercase">Save your work</span>
            </motion.div>
            ...
            <h1 className="font-serif text-4xl leading-[1.05] font-bold tracking-tight sm:text-6xl lg:text-7xl">
              ...
              <span className="text-primary block min-h-[1.1em]"><RotatingWord /></span>
            </h1>

            <p className="text-muted-foreground max-w-lg text-xl leading-relaxed">
              Jobmark gives you one place to write down what you did, fixed, and learned. Use those notes later for reviews and updates.
            </p>
            ...
            <div className="flex flex-col items-start gap-4 pt-2 sm:flex-row sm:items-center">
              ...
              <Link href="#product-tour" className="text-muted-foreground hover:text-foreground inline-flex items-center gap-2 px-6 py-4 text-base transition-colors">
                See how it works
              </Link>
            </div>
          ...
          <motion.div style={{ y: previewY }} className="w-full min-w-0 xl:max-w-[1000px] xl:flex-1">
            <motion.div
              style={prefersReducedMotion ? undefined : { scale: previewScale }}
              initial={prefersReducedMotion ? false : { y: 26 }}
              animate={{ y: 0 }}
            ...
            >
              ...
              />
              <div className="border-primary/20 relative rounded-[1.15rem] border shadow-2xl shadow-black/25 transition-[border-color,box-shadow] duration-500 group-hover:border-primary/40 group-hover:shadow-black/35">
                <DashboardPreview />
                <motion.div
                  aria-hidden="true"
                  className="pointer-events-none absolute inset-x-10 top-0 h-px bg-linear-to-r from-transparent via-primary/70 to-transparent"
                  animate={prefersReducedMotion ? undefined : { x: ['-45%', '45%', '-45%'], opacity: [0.25, 0.7, 0.25] }}
