...
function generateInsights(data: InsightsData): Insight[] {
    ...
    if (avgOlder > 0) {
      ...
      if (changePercent > 25) {
        insights.push({
          ...
          description:
            "You're building strong momentum. This is the perfect time to tackle challenging goals.",
          type: 'success',
        });
        ...
        insights.push({
          ...
          description:
            'Consider setting smaller daily goals to rebuild your routine. Start with just one activity per day.',
          type: 'warning',
        });
      }
    }
  ...
  if (consistencyPercent >= 70) {
    insights.push({
      ...
      description:
        "Excellent discipline! You're logging activities most days. Keep this routine going.",
      type: 'success',
    });
    ...
    insights.push({
      ...
      description:
        'Set a reminder to log one activity each day. Small consistent actions compound over time.',
      type: 'tip',
    });
  }
  ...
  if (weekdayDays > 0 && weekendDays > 0) {
    ...
    if (weekendAvg > weekdayAvg * 1.5) {
      insights.push({
        ...
        description:
          "You're more active on weekends. If possible, protect some weekend time for productivity.",
        type: 'info',
      });
      ...
      insights.push({
        ...
        description:
          'Consider a light weekend routine - even 10 minutes of progress keeps momentum alive.',
        type: 'tip',
      });
    }
  }
