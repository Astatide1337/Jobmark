 ...
 *
 * Why: Users need to take their data out of the app for performance reviews
 * and meetings. This module handles client-side generation of PDF and Word files.
 *
 * Technical Implementation:
 * - PDF: Uses `html2pdf.js`. We manually strip global styles during export
 *   because standard PDF generators often crash when encountering modern
 *   CSS functions like `oklch`.
 * - Word: Generates a raw HTML blob with specific Office-compliant XML namespaces
 *   which Microsoft Word interprets as a native document.
 */
