...
- Review drafts and outreach messages are generated from bounded, authenticated record data without an external model service. When a user chooses an assistant, only the selected draft or task context is handed to that assistant.
